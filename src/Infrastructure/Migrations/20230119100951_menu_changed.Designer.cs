...
namespace ProductTracking.Infrastructure.Migrations
{
    ...
    [Migration("20230119100951_menu_changed")]
            ...
            modelBuilder.Entity("ProductTracking.Core.Entities.AuthAggregate.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "df299433-0a3f-4154-bb1e-e9ccecbc09e8",
                            Email = "SuperAdmin",
                            EmailConfirmed = false,
                            EmployeeId = new Guid("00000000-0000-0000-0000-000000000000"),
                            EntryDate = new DateTime(2023, 1, 19, 10, 9, 49, 407, DateTimeKind.Utc).AddTicks(8373),
            ...
            modelBuilder.Entity("ProductTracking.Core.Entities.Settings.Office", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EntryDate = new DateTime(2023, 1, 19, 15, 54, 49, 408, DateTimeKind.Local).AddTicks(2377),
                            NameEng = "ADO Logistics",
                            NameNep = "ADO Logistics",
                            NameShort = "ADO",
                            Status = 0,
                            UpdatedDate = new DateTime(2023, 1, 19, 15, 54, 49, 408, DateTimeKind.Local).AddTicks(8744),
                            isParrent = false,
                            officeType = 0
                        });
                });
