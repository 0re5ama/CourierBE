...
namespace ProductTracking.Infrastructure.Migrations
{
    ...
    [Migration("20230117134552_change-db")]
            ...
            modelBuilder.Entity("ProductTracking.Core.Entities.AuthAggregate.Menu", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            HasChild = "N",
                            Icon = "form",
                            MenuText = "Checkpoint User Dashboard",
                            OrderNo = 14,
                            SecApl = "N",
                        ...
                        new
                        {
                            ...
                            HasChild = "N",
                            Icon = "form",
                            MUrl = "/consignment-entry",
                            MenuText = "Consignmnet Entry",
                            OrderNo = 4,
                            SecApl = "N",
                        ...
                        new
                        {
                            Id = new Guid("43476d5c-7d71-43bf-8ce3-6d78597b4765"),
                            HasChild = "N",
                            Icon = "form",
                            MenuText = "Consignment Remarks",
                            OrderNo = 5,
                            SecApl = "N",
                            ToolTip = "Consignment Remarks"
                        },
                        new
                        {
                            ...
                            HasChild = "N",
                            Icon = "form",
                            MUrl = "/search-consignment",
                            MenuText = "Search Consignment",
                            OrderNo = 6,
                            ParentId = new Guid("32508cdc-db75-437e-bcc8-6cc67e2c82b2"),
                            SecApl = "N",
                        ...
                        new
                        {
                            ...
                            MenuText = "Container",
                            OrderNo = 8,
                            ParentId = new Guid("d0ac4225-14f7-4b4c-bc0b-ecdfc6003d75"),
                            SecApl = "N",
                            ToolTip = "Container"
                        },
                        new
            ...
            modelBuilder.Entity("ProductTracking.Core.Entities.AuthAggregate.Module", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("94e9e57d-c8d9-4a9a-87d4-fef0c9abe5de"),
                            ApplicationId = new Guid("9e936e4c-c13e-48ab-89b8-e7f72c1c658c"),
                            Description = "Consignment Remarks",
                            FromDate = new DateTime(2022, 8, 19, 0, 0, 0, 0, DateTimeKind.Utc),
                            MenuId = new Guid("43476d5c-7d71-43bf-8ce3-6d78597b4765"),
            ...
            modelBuilder.Entity("ProductTracking.Core.Entities.AuthAggregate.ModuleFunction", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("df052f18-d397-4331-846e-34287180ede6"),
                            FunctionId = 0,
                            ModuleId = new Guid("94e9e57d-c8d9-4a9a-87d4-fef0c9abe5de")
                        },
                        new
                        {
                            Id = new Guid("306fa819-2903-413f-8e36-17c089d4d1a1"),
                            FunctionId = 1,
                            ModuleId = new Guid("94e9e57d-c8d9-4a9a-87d4-fef0c9abe5de")
                        },
                        new
                        {
                            Id = new Guid("5d8355ed-2339-460a-9c97-0938bb87f858"),
                            FunctionId = 2,
                            ModuleId = new Guid("94e9e57d-c8d9-4a9a-87d4-fef0c9abe5de")
                        },
                        new
                        {
                            Id = new Guid("a4df18fe-3f8b-49ad-b560-b18f42a82bd1"),
                            FunctionId = 3,
                            ModuleId = new Guid("94e9e57d-c8d9-4a9a-87d4-fef0c9abe5de")
                        },
                        new
                        {
                            Id = new Guid("c0bf73e0-2fb9-47aa-9b96-9afe13b636af"),
                            FunctionId = 4,
                            ModuleId = new Guid("94e9e57d-c8d9-4a9a-87d4-fef0c9abe5de")
                        },
                        new
            ...
            modelBuilder.Entity("ProductTracking.Core.Entities.AuthAggregate.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d1887fc0-caf5-4b3d-9930-525c8d296e05"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0bfc22f8-d5ee-47ed-aa92-b33f0a547c55",
                            Email = "SuperAdmin",
                            EmailConfirmed = false,
                            EmployeeId = new Guid("00000000-0000-0000-0000-000000000000"),
                            EntryDate = new DateTime(2023, 1, 17, 13, 45, 50, 20, DateTimeKind.Utc).AddTicks(5524),
                            HasPasswordChanged = false,
                            LockoutEnabled = false,
                            Name = "info@superadmin.com",
                            OfficeId = new Guid("187cda14-9844-42e7-99ba-b8d4f0d59c3a"),
            ...
            modelBuilder.Entity("ProductTracking.Core.Entities.Settings.Office", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "Baneshwor",
                            Code = "Test",
                            Contact = "nirvan@gmail.com",
                            EntryDate = new DateTime(2023, 1, 17, 19, 30, 50, 21, DateTimeKind.Local).AddTicks(830),
                            NameEng = "Test Organization",
                            NameNep = "Test Organization",
                            NameShort = "Test",
                            Status = 0,
                            UpdatedDate = new DateTime(2023, 1, 17, 19, 30, 50, 22, DateTimeKind.Local).AddTicks(3124),
                            isParrent = false,
                            officeType = 0
                        });
                });
